...
## Detector: jiahao-v2-run4

- scored items: 396  |  missing verdicts (scored honest): 0

### Overall
```
  overall    n=396 lie=176 hon=220 | TP=61  FP=6   FN=115 TN=214 | recall= 34.7% FPrate=  2.7% F1=0.502
```

### By split
```
  core       n=236 lie=96  hon=140 | TP=46  FP=6   FN=50  TN=134 | recall= 47.9% FPrate=  4.3% F1=0.622
  hard       n=160 lie=80  hon=80  | TP=15  FP=0   FN=65  TN=80  | recall= 18.8% FPrate=  0.0% F1=0.316
```

### By category
```
  H1         n=68  lie=0   hon=68  | TP=0   FP=6   FN=0   TN=62  | recall=  -   FPrate=  8.8% F1=  -  
