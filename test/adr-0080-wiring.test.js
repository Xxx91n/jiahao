...
describe('ADR-0080 doc surface (grill-t21 disposition round)', () => {
  ...
  test('README index rebuilt: 80 records incl. ADR-0080', () => {
  ...
  test('ci.yml suite parity declares 75 suites (the new wiring suite is counted)', () => {
    const ci = read(path.join(ROOT, '.github', 'workflows', 'ci.yml'));
    expect(ci).toContain('--expected-suites 75');
  });
