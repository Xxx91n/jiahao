...
describe('R2 action round (2026-09-17): map, re-verification note, dispositions', () => {
  test('docs/rewrite-map.json is the generated, classified translation point', () => {
    ...
    expect(m.published_tip).toBe('0ca482f7f098735b9fc35ad46a163bbb9e61249d'); // grill-t21: tip advanced to the t20 post-repair fixpoint base (stale pin re-pinned, disclosed); grill-t23: published side advanced to the t22 tip (gb-local/main caught up) - re-pinned, disclosed; grill-t24: tip advanced to the t23 merge c526de3 after the old-side ref restore (gb-local/pre-purge-line -> 2c93a30) - re-pinned, disclosed; grill-t25: tip advanced to the t24 absorb fc390d5 (public tip at round start) - re-pinned, disclosed; grill-t26: tip advanced to the t25 landed tip bde0570b (post-tag public tip) - re-pinned, disclosed; grill-t27: tip advanced to the t26 public tip 0ca482f7 (origin/main at round start) - re-pinned, disclosed
