...
describe('ADR-0033 D2 entry schema', () => {
  ...
  test('seed inventory matches ADR-0033 D5 + ADR-0035 D4/D6 corrections', () => {
    ...
    // grill-t24 doc round (ADR-0083) extends the seed inventory to 63 entries: defer-0069 (first live firing of the ADR-0083 D-E audit-window check lines, presence-condition pending-evaluation).
