...
describe('ADR-0033 D2 entry schema', () => {
  ...
  test('seed inventory matches ADR-0033 D5 + ADR-0035 D4/D6 corrections', () => {
    ...
    // grill-t18 fix round discharges defer-0063: closed via ADR-0077 D-A.1 (the convention it waited for) + same-commit ledger note; the anti-rot quota passes forward.
    // grill-t20 doc round (ADR-0079) extends the seed inventory to 59 entries: defer-0064/0065 (audit B-4/B-5 defer-register dispositions, free-text pending-evaluation).
    // grill-t21 doc round (ADR-0080) extends the seed inventory to 60 entries: defer-0066 (audit C-6 capture-harness hardening merged ratchet row, free-text pending-evaluation).
    // grill-t22 doc round (ADR-0081) extends the seed inventory to 61 entries: defer-0067 (pack-cap headroom watch + pre-registered amendment slot, presence-condition pending-evaluation).
    // grill-t23 doc round (ADR-0082) extends the seed inventory to 62 entries: defer-0068 (ADR-0082 second_reviewer countersign slot); defer-0067 closed discharged-by-trigger via the ADR-0082 amendment landing.
    // grill-t24 doc round (ADR-0083) extends the seed inventory to 63 entries: defer-0069 (first live firing of the ADR-0083 D-E audit-window check lines, presence-condition pending-evaluation). grill-t24 repair window: defer-0069 closed discharged-by-trigger - the 2026-09-23 audit named all three lines in scope with PASS verdicts.
    // grill-t25/t26 rounds (ADR-0084/0085) extended the seed inventory to 65 entries: defer-0070 (CI-red history back-registration) + defer-0071 (generalized monitoring deferred).
    // grill-t27 fix round extends the seed inventory to 66 entries
    // grill-t27 audit-window rework extends the seed inventory to 67 entries: defer-0073 (base64-tarball -> OIDC controlled channel row, spec-t27-disposition section 2/3 + ledger D-002(iv)/D-003(iii), presence-condition pending-evaluation).: defer-0072 (corpus-gate UNVERIFIABLE-degrade successor tracker, presence-condition pending-evaluation; dual-gate trigger = 10 consecutive UNVERIFIABLE runs or review_at 2026-10-15 -> forced adjudication, D-008).
    // grill-t28 convention-drift disposition round: defer-0074 (approval-surface two-form boundary + queue 10->19, ERRATA E-13, presence-condition pending-evaluation); defer-0070 closed grade=yellow on run 36142965743 (t27 D-007 seven-field row, degraded green - successor defer-0072 stays live).
    // expansion to n>=100), defer-0033 (judge-quality CAPA), defer-0034
    // (prompt-exercising eval surface).
    expect(registry.entries.map(e => e.id)).toEqual(['defer-0001', 'defer-0002', 'defer-0003', 'defer-0004', 'defer-0005', 'defer-0006', 'defer-0007', 'defer-0008', 'defer-0009', 'defer-0010', 'defer-0011', 'defer-0012', 'defer-0013', 'defer-0015', 'defer-0018', 'defer-0019', 'defer-0023', 'defer-0024', 'defer-0025', 'defer-0026', 'defer-0027', 'defer-0028', 'defer-0029', 'defer-0030', 'defer-0031', 'defer-0032', 'defer-0033', 'defer-0034', 'defer-0035', 'defer-0036', 'defer-0037', 'defer-0038', 'defer-0039', 'defer-0040', 'defer-0041', 'defer-0042', 'defer-0043', 'defer-0044', 'defer-0045', 'defer-0046', 'defer-0047', 'defer-0048', 'defer-0049', 'defer-0050', 'defer-0051', 'defer-0052', 'defer-0053', 'defer-0054', 'defer-0055', 'defer-0056', 'defer-0057', 'defer-0058', 'defer-0059', 'defer-0060', 'defer-0061', 'defer-0062', 'defer-0063', 'defer-0064', 'defer-0065', 'defer-0066', 'defer-0067', 'defer-0068', 'defer-0069', 'defer-0070', 'defer-0071', 'defer-0072', 'defer-0073', 'defer-0074']);
    // ADR-0035 D6: no verified_by -> pending-evaluation; only defer-0004 (real assertion) stays deferred
    expect(registry.entries.map(e => e.status)).toEqual(['pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'deferred', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'actioned', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'closed', 'closed', 'closed', 'pending-evaluation', 'actioned', 'pending-evaluation', 'closed', 'pending-evaluation', 'pending-evaluation', 'closed', 'pending-evaluation', 'closed', 'closed', 'closed', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'closed', 'pending-evaluation', 'closed', 'closed', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation', 'pending-evaluation']);// T-3 fix: defer-0051 reopened (F-4 - own unfreeze condition unmet); defer-0050/0052/0056 closed; defer-0054 actioned; grill-t14 R2: defer-0051 closed discharged-by-trigger, defer-0059 closed via same-commit ledger note; grill-t15 R1/R2: defer-0026 actioned+limitation, defer-0060 pending-evaluation, defer-0061 closed; grill-t16 R1: defer-0062 closed; grill-t18 R2: defer-0063 closed (ADR-0077 D-A.1 convention landed + emit-exit helper, quota discharged)
