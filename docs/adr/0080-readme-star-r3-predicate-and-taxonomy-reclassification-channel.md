...
- The t21 trend row records `carve_out_used:1` with `governance_tooling_diff.files` naming this round's machinery edits honestly (`.github/workflows/ci.yml`, `scripts/build-governance-anchors.js`, `scripts/check-governance-inventory.js`, `scripts/surface-taxonomy.js`).
