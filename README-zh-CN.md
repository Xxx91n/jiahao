...
<!-- translation-baseline: 0054aab79c5c27a0a4e206c2e83f44d0432117e1 -->
...
```bash
npm test                              # 1384 tests across 82 suites (full corpus tier; the public tier skips 7 corpus-bound tests with reasons, ADR-0056)
...
- `test/` —— 82 test suites, 1384 tests
